...
internal static class GBColors
{
	...
	public static ReadOnlySpan<uint> GetLut(EmuInputLog.EmuPlatform emuPlatform) => emuPlatform switch
	{
		EmuInputLog.EmuPlatform.GB => _trueColorLut,
		EmuInputLog.EmuPlatform.GBC => _cgbColorLut,
		EmuInputLog.EmuPlatform.GBC_GBA or EmuInputLog.EmuPlatform.GBA => _agbColorLut,
		EmuInputLog.EmuPlatform.SGB2 => _sgbColorLut,
